...
import { MapEventProps } from '@vis.gl/react-google-maps/dist/components/map/use-map-events';
import { DeckGlCompatProps } from '@vis.gl/react-google-maps/dist/components/map/use-deckgl-camera-update';
export interface GoogleMapsContextValue {
    map: google.maps.Map | null;
}
export declare const GoogleMapsContext: React.Context<GoogleMapsContextValue | null>;
export type { MapCameraChangedEvent, MapEvent, MapEventProps, MapMouseEvent } from '@vis.gl/react-google-maps/dist/components/map/use-map-events';
